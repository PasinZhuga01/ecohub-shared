    ...
    endpoints: {
        '/get': {
            ...
            response: zod_1.z.array(zod_1.z.object({
                id: db_1.catalogItemSchema.shape.id,
                name: db_1.catalogItemSchema.shape.name,
                count: db_1.catalogItemSchema.shape.count,
                price: db_1.catalogItemSchema.shape.price
            }))
        },
        '/create': {
            method: 'POST',
        ...
        '/edit': {
            ...
            request: zod_1.z.union([
                zod_1.z.object({
                    ...
                    value: db_1.catalogItemSchema.shape.count
                }),
                zod_1.z.object({
                    id: db_1.catalogItemSchema.shape.id,
                    component: zod_1.z.literal('price'),
                    value: db_1.catalogItemSchema.shape.price
                })
            ]),
            response: zod_1.z.object({
                value: zod_1.z.union([db_1.catalogItemSchema.shape.count, db_1.catalogItemSchema.shape.price])
            })
        },
        '/remove': {
            method: 'DELETE',
