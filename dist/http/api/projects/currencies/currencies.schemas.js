    ...
    endpoints: {
        '/get': {
            ...
            response: zod_1.z.array(zod_1.z.object({
                id: db_1.currencySchema.shape.id,
                iconSrc: db_1.currencySchema.shape.icon_src,
                name: db_1.currencySchema.shape.name,
                rate: db_1.currencySchema.shape.rate
            }))
        },
        '/create': {
            method: 'POST',
        ...
        '/shift': {
            ...
            request: zod_1.z.object({
                projectId: db_1.projectSchema.shape.id,
                value: db_1.currencySchema.shape.rate
            }),
            response: schemas_1.successObjectSchema
        }
    }
